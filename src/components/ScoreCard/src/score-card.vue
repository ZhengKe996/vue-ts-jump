<template>
  <div
    class="content block disabled:flex flex-col justify-center items-center w-72 xl:w-96 h-60 xl:h-96 mx-auto my-64 bg-black bg-opacity-40 rounded-xl border-4 border-white border-opacity-5"
  >
    <div
